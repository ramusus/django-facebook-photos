...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'vkontakte_photos.photo': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'like_users': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'like_photos'", 'blank': 'True', 'to': "orm['vkontakte_users.User']"}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos_author'", 'null': 'True', 'to': "orm['vkontakte_users.User']"}),

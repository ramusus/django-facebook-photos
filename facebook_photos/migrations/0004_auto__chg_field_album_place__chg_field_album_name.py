...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Album.place'
        db.alter_column(u'facebook_photos_album', 'place', self.gf('annoying.fields.JSONField')(null=True))

        # Changing field 'Album.name'
        db.alter_column(u'facebook_photos_album', 'name', self.gf('django.db.models.fields.CharField')(max_length='200'))

    def backwards(self, orm):

        # Changing field 'Album.place'
        db.alter_column(u'facebook_photos_album', 'place', self.gf('annoying.fields.JSONField')(default={}, max_length='200'))

        # Changing field 'Album.name'
        db.alter_column(u'facebook_photos_album', 'name', self.gf('django.db.models.fields.CharField')(max_length='500'))

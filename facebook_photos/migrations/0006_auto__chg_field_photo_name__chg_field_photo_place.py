...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'facebook_photos_photo', 'name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Photo.place'
        db.alter_column(u'facebook_photos_photo', 'place', self.gf('annoying.fields.JSONField')(null=True))

    def backwards(self, orm):

        # Changing field 'Photo.name'
        db.alter_column(u'facebook_photos_photo', 'name', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Photo.place'
        db.alter_column(u'facebook_photos_photo', 'place', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

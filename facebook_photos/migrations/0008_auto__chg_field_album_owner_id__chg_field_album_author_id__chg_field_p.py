...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Album.owner_id'
        db.alter_column(u'facebook_photos_album', 'owner_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Album.author_id'
        db.alter_column(u'facebook_photos_album', 'author_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Photo.author_id'
        db.alter_column(u'facebook_photos_photo', 'author_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Album.owner_id'
        db.alter_column(u'facebook_photos_album', 'owner_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Album.author_id'
        db.alter_column(u'facebook_photos_album', 'author_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Photo.author_id'
        db.alter_column(u'facebook_photos_photo', 'author_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.actions_count'
        db.add_column(u'facebook_photos_album', 'actions_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Photo.actions_count'
        db.add_column(u'facebook_photos_photo', 'actions_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Album.actions_count'
        db.delete_column(u'facebook_photos_album', 'actions_count')

        # Deleting field 'Photo.actions_count'
        db.delete_column(u'facebook_photos_photo', 'actions_count')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'vkontakte_photos_album', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Album.created'
        raise RuntimeError("Cannot reverse this migration. 'Album.created' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Album.created'
        db.alter_column(u'vkontakte_photos_album', 'created', self.gf('django.db.models.fields.DateTimeField')())

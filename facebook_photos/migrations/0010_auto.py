...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Album', fields ['fetched']
        db.create_index(u'vkontakte_photos_album', ['fetched'])

        # Adding index on 'Photo', fields ['fetched']
        db.create_index(u'vkontakte_photos_photo', ['fetched'])


    def backwards(self, orm):
        # Removing index on 'Photo', fields ['fetched']
        db.delete_index(u'vkontakte_photos_photo', ['fetched'])

        # Removing index on 'Album', fields ['fetched']
        db.delete_index(u'vkontakte_photos_album', ['fetched'])

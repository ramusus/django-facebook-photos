...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'facebook_photos_album', 'place', self.gf('annoying.fields.JSONField')(max_length='200'))

    def backwards(self, orm):

        # Changing field 'Album.place'
        db.alter_column(u'facebook_photos_album', 'place', self.gf(
    ...
    models = {
        ...
        u'facebook_photos.album': {
            ...
            'place': ('annoying.fields.JSONField', [], {'max_length': "'200'"}),

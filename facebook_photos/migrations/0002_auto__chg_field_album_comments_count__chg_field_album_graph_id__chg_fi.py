...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Album.comments_count'
        db.alter_column(u'facebook_photos_album', 'comments_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Album.graph_id'
        db.alter_column(u'facebook_photos_album', 'graph_id', self.gf('django.db.models.fields.BigIntegerField')(unique=True, primary_key=True))

        # Changing field 'Album.shares_count'
        db.alter_column(u'facebook_photos_album', 'shares_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Album.likes_count'
        db.alter_column(u'facebook_photos_album', 'likes_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Photo.graph_id'
        db.alter_column(u'facebook_photos_photo', 'graph_id', self.gf('django.db.models.fields.BigIntegerField')(unique=True, primary_key=True))

        # Changing field 'Photo.shares_count'
        db.alter_column(u'facebook_photos_photo', 'shares_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Photo.comments_count'
        db.alter_column(u'facebook_photos_photo', 'comments_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Photo.likes_count'
        db.alter_column(u'facebook_photos_photo', 'likes_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Album.comments_count'
        db.alter_column(u'facebook_photos_album', 'comments_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Album.graph_id'
        db.alter_column(u'facebook_photos_album', 'graph_id', self.gf('django.db.models.fields.BigIntegerField')(max_length=100, unique=True, primary_key=True))

        # Changing field 'Album.shares_count'
        db.alter_column(u'facebook_photos_album', 'shares_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Album.likes_count'
        db.alter_column(u'facebook_photos_album', 'likes_count', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Photo.graph_id'
        db.alter_column(u'facebook_photos_photo', 'graph_id', self.gf('django.db.models.fields.BigIntegerField')(max_length=100, unique=True, primary_key=True))

        # Changing field 'Photo.shares_count'
        db.alter_column(u'facebook_photos_photo', 'shares_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Photo.comments_count'
        db.alter_column(u'facebook_photos_photo', 'comments_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Photo.likes_count'
        db.alter_column(u'facebook_photos_photo', 'likes_count', self.gf('django.db.models.fields.IntegerField')())

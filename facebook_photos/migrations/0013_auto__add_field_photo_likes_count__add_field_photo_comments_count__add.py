...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'vkontakte_photos_photo', 'likes_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Photo.comments_count'
        db.add_column(u'vkontakte_photos_photo', 'comments_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Photo.actions_count'
        db.add_column(u'vkontakte_photos_photo', 'actions_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Photo.tags_count'
        db.add_column(u'vkontakte_photos_photo', 'tags_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'vkontakte_photos_photo', 'likes_count')

        # Deleting field 'Photo.comments_count'
        db.delete_column(u'vkontakte_photos_photo', 'comments_count')

        # Deleting field 'Photo.actions_count'
        db.delete_column(u'vkontakte_photos_photo', 'actions_count')

        # Deleting field 'Photo.tags_count'
        db.delete_column(u'vkontakte_photos_photo', 'tags_count')
    ...
    models = {
        ...
        u'vkontakte_photos.comment': {
            ...
            'fetched': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wall_comments'", 'to': u"orm['vkontakte_photos.Photo']"}),
            'remote_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': "'20'"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Photo.likes'
        db.delete_column(u'vkontakte_photos_photo', 'likes')

        # Deleting field 'Photo.comments'
        db.delete_column(u'vkontakte_photos_photo', 'comments')

        # Deleting field 'Photo.tags'
        db.delete_column(u'vkontakte_photos_photo', 'tags')


    def backwards(self, orm):
        # Adding field 'Photo.likes'
        db.add_column(u'vkontakte_photos_photo', 'likes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Photo.comments'
        db.add_column(u'vkontakte_photos_photo', 'comments',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Photo.tags'
        db.add_column(u'vkontakte_photos_photo', 'tags',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)
